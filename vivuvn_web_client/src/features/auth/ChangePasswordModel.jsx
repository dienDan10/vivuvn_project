		...
		>
			<div className="py-4">
				<div className="text-center mb-6 flex flex-col items-center">
					<FaCircleUser className="text-5xl text-blue-700 mb-2" />
					...
					<div className="mt-6">
						{isPending ? (
							...
							<button
								type="button"
								onClick={() => form.submit()}
								className="w-full bg-blue-700 hover:cursor-pointer font-semibold text-white py-2 px-4 rounded-3xl shadow-sm hover:bg-red-400 focus:outline-none focus:ring-2 focus:ring-gray-500 transition-colors duration-200"
							>
								Change Password
							</button>
						)}
